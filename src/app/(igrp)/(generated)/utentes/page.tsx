...
export default function PageUtentesComponent() {
  ...
  async function handleInativar(rowData: any): Promise<void | undefined> {
    try {
        ...
        <div className={cn(' border rounded-sm p-4')}>
          ...
          >
            <IGRPCombobox
              ...
              className={cn('col-span-1')}
              onChange={(value) => {
                setTpUtenteFlt(value as string);
              }}
          ...
          <IGRPDataTable<Table1, Table1>
            ...
            columns={[
              {
                header: ({ column }) => (
                  <IGRPDataTableHeaderSortToggle column={column} title={`Nº Utente`} />
                ),
                accessorKey: 'numero',
                cell: ({ row }) => {
              ...
              {
                header: ({ column }) => (
                  <IGRPDataTableHeaderSortToggle column={column} title={`Tipo`} />
                ),
              ...
              {
                header: ({ column }) => (
                  <IGRPDataTableHeaderSortToggle column={column} title={`NIF`} />
                ),
                accessorKey: 'nif',
                cell: ({ row }) => {
              ...
              },
              {
                ...
                cell: ({ row }) => {
                  ...
                  return (
                    <IGRPDataTableCellBadge
                      label={label ?? row.original.estadoDesc}
                      variant={`soft`}
                        ...
                        items={[
                          {
                            ...
                            props: {
                              ...
                              icon: `UserCog`,
                              href: `/utentes/${row.original.id}/detalhes`,
                              showIcon: true,
                            },
                          },
                          {
                            component: IGRPDataTableDropdownMenuLink,
                            props: {
                              labelTrigger: `Divida do Utente`,
                              icon: `CreditCard`,
                              href: `/utentes/${row.original.id}/divida`,
                              showIcon: true,
                            },
                          },
